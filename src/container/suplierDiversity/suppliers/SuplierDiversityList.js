...
import SuplierDiversityDetails from './SuplierDiversityDetails';

const SuplierDiversityList = ({ marketerData, handleDelete, rowSelection, handleChange, isModalOpen, setIsModalOpen, onLockToggle, selectedRows, setSelectedRows,
    ...
    const datalist = [
        {
          regdate: "11/11/2024",
          company: "Company #1",
          ContactPerson: "John Adam ",
          Date: "11/11/2024",
          Email: "submitted@gmail.com",
          PhoneNumber: "3434343678",
    ...
    const columns = [
        {
          ...
          Cell: ({ row }) => (
            <span onClick={() => handleAddEdit(row)} >
              <Typography sx={{ ml: 1 }}>{row.original.regdate}</Typography>
...
export default SuplierDiversityList;