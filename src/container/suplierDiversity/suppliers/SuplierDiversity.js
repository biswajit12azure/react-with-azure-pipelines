...
import SuplierDiversityList from "./SuplierDiversityList";
import { alertActions } from '_store';
import {  ModalPopup } from '_components';
import { marketerAction } from '_store/marketer.slice';
import dayjs from 'dayjs';
import SuplierDiversityFilter from "./SuplierDiversityFilter"
import { Download } from '_components';

const SuplierDiversity = () => {
  ...
  return (
    <>
      <Typography component="div" className='userprofilelist '>
        <Grid container direction="row" spacing={2}>
          ...
          <Grid size={{ xs: 12, sm: 12, md: 4 }}>
            <Typography variant="h2" className='userprofilelistcontent'>SuplierDiversity</Typography>
      ...
      <Box className="SuplierDiversity">
        <Grid container spacing={2}>
          <Grid size={{ xs: 12, sm: 6, md: 3 }} className="SuplierDiversitycontainer">
            <Grid container >
              <Grid size={{ xs: 12, sm: 6, md: 6 }}>
                <Typography component="h3">Registered Suppliers</Typography>
              </Grid>
              <Grid size={{ xs: 12, sm: 6, md: 6 }}>
                <Typography component="h4">2,658</Typography>
              </Grid>
            </Grid>
          </Grid>
          <Grid size={{ xs: 12, sm: 6, md: 3 }} className="SuplierDiversitycontainer">
            <Grid container >
              <Grid size={{ xs: 12, sm: 6, md: 6 }}>
                <Typography component="h3">new
                  Supplierss</Typography>
              </Grid>
              <Grid size={{ xs: 12, sm: 6, md: 6 }}>
                <Typography component="h4">20</Typography>
              </Grid>
            </Grid>


          </Grid>
          <Grid size={{ xs: 12, sm: 12, md: 6 }} className="SuplierDiversitycontainer">
            <Grid container >
              <Grid size={{ xs: 12, sm: 4, md: 4 }}>
                <Typography component="h3">certifications expiring in </Typography>
              </Grid>
              <Grid size={{ xs: 12, sm: 8, md: 8 }} className="SuplierDiversitycertifications">
                <Grid container >
                  <Grid size={{ xs: 12, sm: 4, md: 4 }}>
      ...
      <div className='MarketerList MapCentercontainer'>
        <SuplierDiversityList
          marketerData={data}
...
export default SuplierDiversity;