...
const ActivityFilter = ({portalID, handleFilterSubmit, isOpen, onClose, onOpen }) => {
    const header = "Actvity Log";
                            ...
                            <Typography component="div" className='userprofilelist'>
                                <Grid container direction="row" spacing={{ xs: 2, md: 3 }}>
                                    <Grid item xs={12} sm={6} md={6}>
                                        <Typography variant="h2" className='userprofilelistcontent'>Activity Log Filter</Typography>
                                    </Grid>
                                </Grid>
                            </Typography>
