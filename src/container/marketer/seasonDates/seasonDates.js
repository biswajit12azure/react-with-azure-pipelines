...
import SeasonDatesCreate from "./seasonDatesCreate";
import { Typography, Backdrop, CircularProgress, Button } from "@mui/material";
import Grid from "@mui/material/Grid2";
import SeasonDatesList from "./seasonDatesList";
      ...
      <Typography component="div" className='userprofilelist'>
            <Grid container  direction="row" spacing={2}>
              <Grid size={{ xs: 12, sm: 12, md: 4 }}>
                <Typography variant="h2" className='userprofilelistcontent'>Season Dates</Typography>
              </Grid>
