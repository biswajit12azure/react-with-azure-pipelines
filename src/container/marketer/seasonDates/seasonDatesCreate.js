...
const SeasonDatesCreate = ({ handleFilterSubmit, isOpen, onClose, onOpen }) => {
    ...
    return (
        <>
            <Button className='Download' type="button" variant="contained" color="primary" aria-describedby={id} onClick={handleClick}>
                <AddCircleOutline />Season
            </Button>
                        ...
                        <Typography component="div" className='userprofilelist'>
                            <Grid container direction="row" spacing={{ xs: 2, md: 3 }}>
                                <Grid item xs={12} sm={12} md={12}>
                                    <Typography variant="h2" className='userprofilelistcontent'>Create new season</Typography>
                                </Grid>
                            </Grid>
                        </Typography>
...
export default SeasonDatesCreate;