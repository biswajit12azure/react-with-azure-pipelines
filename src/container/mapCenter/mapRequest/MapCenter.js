...
import MapCenterFilter from "./MapCenterFilter"
import { Download } from '_components';
import MapCenterRequest from './MapCenterRequest';
const MapCenter = () => {
      ...
      <Typography component="div" className='userprofilelist '>
        <Grid container direction="row" spacing={2}>
              ...
              <Grid size={{ xs: 12, sm: 12, md: 4 }}>
                <Typography variant="h2" className='userprofilelistcontent'>Map Center</Typography>
