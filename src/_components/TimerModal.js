    ...
    <div>
      ...
      >
        ...
        <Link href="#" variant="logo" className="wgllogo">
                        ...
                        {/* <DialogTitle id="alert-dialog-title"  className="headercontent mobile-none notificationtitle" >{header}</DialogTitle> */}
        ...
        <Typography component="div"  className='alertTypeinner'>
         { alertType && <img src={ alertType==='error' ? error : Check} alt="Check"></img>}                  
          ...
          <DialogTitle id="alert-dialog-title"  className="headercontent  notificationtitle" >{header}</DialogTitle>
